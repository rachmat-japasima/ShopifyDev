...
(function(){
  ...
  theme.Collection = (function() {
    ...
    var selectors = {
      ...
      productsGrid: '#CollectionProducts',
      trigger: '.collapsible-trigger',
      sidebar: '#CollectionSidebar',
        ...
        sections: [
          {
            ...
            nodeId: 'CollectionProductWithFilters',
          },
        ],
    ...
    Collection.prototype = Object.assign({}, Collection.prototype, {
        ...
        if (parent.classList.contains(classes.activeTag)) {
          ...
          if (el.closest('li').classList.contains(classes.removeTagParent)) {
            ...
            document.querySelectorAll(selectors.activeTagList).forEach(list => {
              ...
              newTagLink.href = textEl.dataset.url;
              newTag.appendChild(newTagLink);
              newTag.addEventListener('click', this.tagClick);
      ...
      startLoading: function() {
        document.querySelector(selectors.productsGrid).classList.add('unload');
      },

      endLoading: function() {
        document.querySelector(selectors.productsGrid).classList.remove('unload');
      },
    });
